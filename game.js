...
// IMPORTANT: attach AFTER DOM exists
window.onload = () => {
  document.getElementById("startBtn").onclick = startGame;
  document.getElementById("restartBtn").onclick = restartFromCheckpoint;
...
function lane(y) {
  if (!world[y]) {
    ...
    if (y % CHECKPOINT_STEP === 0) {
      world[y] = { type: "grass", checkpoint: true };
      return world[y];
    }
